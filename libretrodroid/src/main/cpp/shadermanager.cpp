...
const std::string ShaderManager::cut2UpscalePass0Fragment =
    ...
    "  result += step(threshold, abs(l3 - l1)) * step(abs(l2 - l1), threshold) * step(abs(l2 - l3), threshold);\n"
    "  result -= step(threshold, abs(l2 - l0)) * step(abs(l0 - l1), threshold) * step(abs(l2 - l1), threshold);\n"
    "  return result;\n"
    "}\n"
    "\n"
    "void main() {\n"
