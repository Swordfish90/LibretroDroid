...
//            "}\n"
    ...
    const std::string ShaderManager::cut3UpscalePass1Fragment =
            ...
            "    int currentPattern = pattern(texture2D(previousPass, coords).y);\n"
            ...
            "  int pattern = pattern(previousPassPixel.y);\n"
            "\n"
            ...
            "#endif\n"
            "\n"
            "  int originalPattern = pattern(previousPassPixel.x);\n"
