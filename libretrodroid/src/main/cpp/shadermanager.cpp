...
const std::string ShaderManager::cut3UpscalePass0Fragment =
    ...
    "}\n"
    "\n"
    "lowp vec2 range(lowp vec2 v) {\n"
    "  return vec2(min(v.x, v.y), max(v.x, v.y));\n"
    "}\n"
    "lowp vec2 rangeMerge(lowp vec2 r1, lowp vec2 r2) {\n"
    "  return vec2(min(r1.x, r2.x), max(r1.y, r2.y));\n"
    "}\n"
    "lowp float rangeExtension(lowp vec2 r) {\n"
    "  return r.y - r.x;\n"
    "}\n"
    "bvec2 hasDiagonal(lowp vec2 left, lowp vec2 main, lowp vec2 right) {\n"
    "  lowp vec2 leftRange = range(left);\n"
    "  lowp vec2 mainRange = range(main);\n"
    "  lowp vec2 rightRange = range(right);\n"
    "  lowp vec2 mainLeftRange = rangeMerge(mainRange, leftRange);\n"
    "  lowp vec2 mainRightRange = rangeMerge(mainRange, rightRange);\n"
    "  lowp float maxContrast = rangeExtension(rangeMerge(mainLeftRange, mainRightRange));\n"
    "  lowp float minContrastMainLeft = max(rangeExtension(mainLeftRange), rangeExtension(rightRange));\n"
    "  lowp float minContrastMainRight = max(rangeExtension(mainRightRange), rangeExtension(leftRange));\n"
    "\n"
    "  bool leftCut = minContrastMainLeft < minContrastMainRight;\n"
    "  lowp float minContrast = leftCut ? minContrastMainLeft : minContrastMainRight;\n"
    "  bool cut = EDGE_MIN_CONTRAST * minContrast + EDGE_MIN_VALUE < maxContrast;\n"
    "\n"
    "  return bvec2(cut, leftCut);\n"
    "}\n"
    ...
    "  return EDGE_MIN_CONTRAST * diff1 + EDGE_MIN_VALUE < diff2;\n"
    "}\n"
    "bool isSaddle(lowp float d1, lowp float d2, lowp float d3, lowp float d4) {\n"
    "  bool sameDiagonals = abs(d1 - d2) < EDGE_MIN_VALUE && abs(d3 - d4) < EDGE_MIN_VALUE;\n"
    "  bool hasContrast = max(abs(d1 - d3), abs(d2 - d4)) > EDGE_MIN_VALUE;\n"
    "  return sameDiagonals && hasContrast;\n"
    "}\n"
    ...
    "\n"
    "  // Main diagonals\n"
    "  bool d05_10 = hasDiagonal(l05, l10, l06, l09);\n"
    "  bool d06_09 = hasDiagonal(l06, l09, l05, l10);\n"
    "\n"
    "  // Saddle fix\n"
    "  if (isSaddle(l05, l10, l06, l09)) {\n"
    "    lowp float average = (l01 + l02 + l04 + l07 + l08 + l11 + l13 + l14) / 8.0;\n"
    "    lowp float diff1 = max(abs(l05 - average), abs(l10 - average));\n"
    "    lowp float diff2 = max(abs(l06 - average), abs(l09 - average));\n"
    "    d05_10 = diff2 + EDGE_MIN_VALUE < diff1;\n"
    "    d06_09 = diff1 + EDGE_MIN_VALUE < diff2;\n"
    "  }\n"
    "\n"
    "  // Vertical diagonals\n"
    "  bvec2 d01_10 = hasDiagonal(vec2(l02, l06), vec2(l01, l10), vec2(l05, l09));\n"
    "  bvec2 d02_09 = hasDiagonal(vec2(l01, l05), vec2(l02, l09), vec2(l06, l10));\n"
    "  bvec2 d05_14 = hasDiagonal(vec2(l09, l13), vec2(l05, l14), vec2(l06, l10));\n"
    "  bvec2 d06_13 = hasDiagonal(vec2(l10, l14), vec2(l06, l13), vec2(l05, l09));\n"
    "\n"
    "  // Horizontal diagonals\n"
    "  bvec2 d04_10 = hasDiagonal(vec2(l08, l09), vec2(l04, l10), vec2(l05, l06));\n"
    "  bvec2 d06_08 = hasDiagonal(vec2(l04, l05), vec2(l06, l08), vec2(l09, l10));\n"
    "  bvec2 d05_11 = hasDiagonal(vec2(l06, l07), vec2(l05, l11), vec2(l09, l10));\n"
    "  bvec2 d07_09 = hasDiagonal(vec2(l10, l11), vec2(l07, l09), vec2(l05, l06));\n"
    "\n"
    "  bvec4 pattern5 = bvec4(d02_09.x && d06_08.x, d01_10.x && d05_11.x, d06_13.x && d07_09.x, d05_14.x && d04_10.x);\n"
    "  bvec4 pattern4 = bvec4(d05_11.x && d06_08.x, d04_10.x && d07_09.x, d05_14.x && d02_09.x, d01_10.x && d06_13.x);\n"
    "  bvec4 pattern3 = bvec4(d05_11.x && d04_10.x, d06_08.x && d07_09.x, d01_10.x && d05_14.x, d02_09.x && d06_13.x);\n"
    "  bvec4 pattern2_v = bvec4(d01_10.x, d02_09.x, d05_14.x, d06_13.x);\n"
    "  bvec4 pattern2_h = bvec4(d04_10.x, d06_08.x, d05_11.x, d07_09.x);\n"
    ...
    "    final.x = 0.35;\n"
    "    final.y = pack(pattern3.w, pattern3.y, pattern3.x || pattern3.y);\n"
...
const std::string ShaderManager::cut3UpscalePass1Fragment =
    ...
    "  #else\n"
    "  lowp float result = STATIC_BLEND_SHARPNESS;\n"
    "  #endif\n"
    "  return result;\n"
    "}\n"
    "\n"
    ...
    "}\n"
    "\n"
    "lowp vec3 pattern0(inout lowp mat4 cs, lowp vec3 flags, lowp vec2 pxCoords) {\n"
    "  cs = mat4(cs[0], cs[1], cs[2], cs[3]);\n"
    "  return vec3(0.0, pxCoords.x, pxCoords.y);\n"
    "}\n"
    "lowp vec3 pattern1(inout lowp mat4 cs, lowp vec3 flags, lowp vec2 pxCoords) {\n"
    "  lowp vec3 result;\n"
    ...
    "}\n"
    "\n"
    "lowp vec3 pattern2(inout lowp mat4 cs, lowp vec3 flags, lowp vec2 pxCoords) {\n"
    "  lowp vec3 result;\n"
    "  lowp vec4 cd = max(flags.x, flags.y) > 0.5 ? cs[2] : cs[3];\n"
    ...
    "}\n"
    "\n"
    "lowp vec3 pattern3(inout lowp mat4 cs, lowp vec3 flags, lowp vec2 pxCoords) {\n"
    "  lowp vec3 result;\n"
    "  lowp vec4 ab = flags.y > 0.5 ? cs[1] : cs[0];\n"
    "  lowp vec4 cd = flags.x > 0.5 ? cs[2] : cs[3];\n"
    "\n"
    "  if (pxCoords.y > 2.0 * pxCoords.x) {\n"
    "    cs = mat4(cs[0], cs[2], cs[2], cd);\n"
    "    result = vec3(1.0, pxCoords.x * 2.0, pxCoords.y);\n"
    ...
    "}\n"
    "\n"
    "lowp vec3 pattern4(inout lowp mat4 cs, lowp vec3 flags, lowp vec2 pxCoords) {\n"
    "  lowp vec3 result;\n"
    "  lowp vec4 ab = flags.y > 0.5 ? cs[0] : cs[1];\n"
    "  lowp vec4 cd = flags.x > 0.5 ? cs[2] : cs[3];\n"
    "\n"
    "  if (pxCoords.x < 0.5) {\n"
    ...
    "\n"
    "  if (pattern == 0) {\n"
    "    result = pattern0(colors, patternFlags, pxCoords);\n"
    "  } else if (pattern == 1) {\n"
    "    result = pattern1(colors, patternFlags, pxCoords);\n"
    "  } else if (pattern == 2) {\n"
    "    result = pattern2(colors, patternFlags, pxCoords);\n"
    "  } else if (pattern == 3) {\n"
    "    result = pattern3(colors, patternFlags, pxCoords);\n"
    "  } else if (pattern == 4) {\n"
    "    result = pattern4(colors, patternFlags, pxCoords);\n"
    "  } else {\n"
    "    result = pattern5(colors, patternFlags, pxCoords);\n"
    "  }\n"
    "\n"
