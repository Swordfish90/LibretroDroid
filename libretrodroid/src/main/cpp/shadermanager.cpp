...
const std::string ShaderManager::cut2UpscalePass0Fragment =
    ...
    "}\n"
    "\n"
    "bool needsSharpening(lowp float n, lowp float e, lowp float s, lowp float w, lowp float c) {\n"
    "  lowp float rangeMax = maxOf(n, e, s, w);\n"
    "  lowp float rangeMin = minOf(n, e, s, w);\n"
    "  lowp float threshold = max(EDGE_SHARPENING_MIN_VALUE, EDGE_SHARPENING_THRESHOLD * (rangeMax - rangeMin));\n"
    "  return c > rangeMin + threshold && c < rangeMax - threshold;\n"
    "}\n"
    "\n"
    "void main() {\n"
    ...
    "#if EDGE_SHARPENING\n"
    "  flags.sharpen = bvec4(\n"
    "    needsSharpening(l01, l06, l09, l04, l05),\n"
    "    needsSharpening(l02, l07, l10, l05, l06),\n"
    "    needsSharpening(l05, l10, l13, l08, l09),\n"
    "    needsSharpening(l06, l11, l14, l09, l10)\n"
    ");\n"
    "#endif\n"
    "\n"
    "  gl_FragColor = vec4(\n"
    ...
    "    pack(flags.sharpen.x, flags.sharpen.y, flags.sharpen.z, flags.sharpen.w),\n"
    "    1.0\n"
    "  );\n"
    "}";
...
const std::string ShaderManager::cut2UpscalePass1Fragment =
    ...
    "\n"
    "#if EDGE_SHARPENING\n"
    "  flags.sharpen = vec4(1.0) - floatUnpack(floor(flagsPixel.z * 255.0 + 0.5));\n"
    "#endif\n"
    "\n"
    "  return flags;\n"
    "}\n"
    ...
    "#if EDGE_SHARPENING\n"
    "  lowp float threshold = (a.a - b.a) * (1.0 - distance(luma(a), luma(b))) * EDGE_SHARPENING_AMOUNT;\n"
    "  lowp float nt = linearStep(max(0.0, threshold), min(1.0, 1.0 + threshold), t);\n"
    ...
    "    vec4(t05, flags.sharpen.x),\n"
    "    vec4(t06, flags.sharpen.y),\n"
    "    vec4(t09, flags.sharpen.z),\n"
    "    vec4(t10, flags.sharpen.w)\n"
    "  );\n"
    "#else\n"
    "  Pixels pixels = Pixels(t05, t06, t09, t10);\n"
    "#endif\n"
