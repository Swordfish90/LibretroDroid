...
const std::string ShaderManager::cut2UpscalePass0Fragment =
    ...
    "  flags.gradients.x = isGradient(l04, l05, l06) || isGradient(l01, l05, l09);\n"
    "  flags.gradients.y = isGradient(l05, l06, l07) || isGradient(l02, l06, l10);\n"
    "  flags.gradients.z = isGradient(l08, l09, l10) || isGradient(l05, l09, l13);\n"
    "  flags.gradients.w = isGradient(l09, l10, l11) || isGradient(l06, l10, l14);\n"
    "#endif\n"
    "\n"
    "  gl_FragColor = vec4(\n"
...
const std::string ShaderManager::cut2UpscalePass1Fragment =
    ...
    "  lowp float nt = t + (b.a - a.a) * (0.5 - sharpness);\n"
//    "  lowp float nt = clamp(t + clamp(b.a - a.a, - 0.5 + sharpness, 0.5 - sharpness), 0.0, 1.0);\n"
