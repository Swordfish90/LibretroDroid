...
const std::string ShaderManager::cut2UpscalePass0Fragment =
    ...
    "}\n"
    "\n"
    "Range rangeOf(lowp float a, lowp float b, lowp float c) {\n"
    "  return rangeOf(rangeOf(a, b), rangeOf(c));\n"
    "}\n"
    "\n"
    ...
    "}\n"
    "\n"
    "bool isEdge2(Range rangeA, Range rangeB) {\n"
    "  Range contrast = rangeOf(rangeA, rangeB);\n"
    "  return max(EDGE_MIN_CONTRAST * rangeExtension(rangeA), EDGE_MIN_VALUE) < rangeExtension(contrast);\n"
    "}\n"
    "\n"
    ...
    "\n"
    "  // Main diagonals\n"
    "  Range r05_10 = rangeOf(l05, l10);\n"
    "  Range r06_09 = rangeOf(l06, l09);\n"
    "  bool d05_10 = isEdge2(r05_10, r06_09);\n"
    "  bool d06_09 = isEdge2(r06_09, r05_10);\n"
    "\n"
    "  if (d05_10 && d06_09) {\n"
    ...
    "#endif\n"
    "\n"
    "  edges = flipEdges(edges, flags.flip);\n"
    "\n"
    "  gl_FragColor = vec4(\n"
    "    flags.type,\n"
    "    quickPackBools3(flags.flip),\n"
    "    quickPackFloats2((edges.xy + 1.0) * 0.5),\n"
    "    quickPackFloats2((edges.zw + 1.0) * 0.5)\n"
    "  );\n"
    "}";
...
const std::string ShaderManager::cut2UpscalePass1Fragment =
    ...
    "  bvec3 flagBits = quickUnpackBools3(flagsPixel.y);\n"
    "  lowp vec2 edgeWeights0 = quickUnpackFloats2(flagsPixel.z) - 0.5;\n"
    "  lowp vec2 edgeWeights1 = quickUnpackFloats2(flagsPixel.w) - 0.5;\n"
    "\n"
    "  Flags flags;\n"
