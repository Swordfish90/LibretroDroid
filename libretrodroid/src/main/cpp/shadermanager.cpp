...
//            "}\n"
            ...
            "  bvec2 flags = bvec2(isTriangle, isInvertedTriangle);\n"
            "\n"
            "  ivec4 ns = ivec4(\n"
            "    fastPattern(gn),\n"
            "    fastPattern(ge),\n"
            ...
            "  result.x = float(pattern) / 4.0;\n"
            "  result.w = quickPackBools2(flags);\n"
            "\n"
            "#if REDUCE_ANTI_ALIASING\n"
    ...
    const std::string ShaderManager::cut3UpscalePass1Fragment =
            ...
            "    int currentPattern = pattern(texture2D(previousPass, coords).x);\n"
            ...
            "  int pattern = pattern(previousPassPixel.x);\n"
            "\n"
