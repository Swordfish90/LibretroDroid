...
const std::string ShaderManager::cut2UpscalePass0Fragment =
    ...
    "  bool isDiagonal = diagonalContrast >= defaultContrast;\n"
    "\n"
    ...
    "  }\n"
    "\n"
    "  lowp vec2 sortedGradient = absCrossGradient.x > absCrossGradient.y ? absCrossGradient.yx : absCrossGradient.xy;\n"
    "  bool reject = isDiagonal\n"
    "    ? sortedGradient.x > 0.26794919243 * sortedGradient.y\n"
    "    : sortedGradient.x < 0.57735026919 * sortedGradient.y;\n"
    "\n"
    "  if (reject) {\n"
    "    result = -result;\n"
    "  }\n"
