...
const std::string ShaderManager::cut2UpscaleFragment =
    ...
    "  }\n"
    "  lowp vec3 p0 = mix(points[0], points[1], sharpSmooth(ws.x, sharpnessHigh));\n"
    "  lowp vec3 p1 = mix(points[2], points[3], sharpSmooth(ws.y, sharpnessHigh));\n"
    "  return mix(p0, p1, sharpSmooth(p.y, sharpnessLow));\n"
    "}\n"
    "\n"
    "void main() {\n"
