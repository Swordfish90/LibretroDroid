...
const std::string ShaderManager::cut3UpscalePass0Fragment =
    ...
    "uniform mediump float screenDensity;\n"
    "\n"
    "#define MIN_SADDLE 0.1\n"
    "#define MIN_EDGE_1 0.02\n"
    "#define EDGE_1_THRESHOLD 2.0\n"
    "#define MIN_EDGE_2 0.35\n"
    "#define EDGE_2_THRESHOLD 1.5\n"
    "\n"
    "varying HIGHP vec2 screenCoords;\n"
    "varying HIGHP vec2 coords;\n"
    "varying HIGHP vec2 c1;\n"
    ...
    "  lowp float diff1 = abs(d1.y - d2.y);\n"
    ...
    "\n"
    "  // Vertical diagonals\n"
    "  lowp float d01_10 = hasDiagonal(vec3(l5, l1, l2), vec3(l6, l10, l9));\n"
    "  lowp float d02_09 = hasDiagonal(vec3(l1, l2, l6), vec3(l10, l9, l5));\n"
    "  lowp float d05_14 = hasDiagonal(vec3(l9, l5, l6), vec3(l10, l14, l13));\n"
    "  lowp float d06_13 = hasDiagonal(vec3(l5, l6, l10), vec3(l14, l13, l9));\n"
    "\n"
    "  // Horizontal diagonals\n"
    "  lowp float d04_10 = hasDiagonal(vec3(l8, l4, l5), vec3(l6, l10, l9));\n"
    "  lowp float d06_08 = hasDiagonal(vec3(l9, l8, l4), vec3(l5, l6, l10));\n"
    "  lowp float d05_11 = hasDiagonal(vec3(l9, l5, l6), vec3(l7, l11, l10));\n"
    "  lowp float d07_09 = hasDiagonal(vec3(l10, l9, l5), vec3(l6, l7, l11));\n"
    "\n"
...
//    "  gl_FragColor = vec4(vec3(c5.x), 1.0);\n"
...
const std::string ShaderManager::cut3UpscalePass1Fragment =
    ...
    "lowp float aaWeight1(bool draw, lowp float dist) {\n"
    "  lowp float weight = max(0.0, 1.0 - abs(dist) / (0.5 * sqrt(2.0)));\n"
    "  return (draw ? 1.0 : 0.0) * weight;\n"
    "}\n"
    "lowp float aaWeight(lowp vec2 pxCoords, lowp float draw, lowp vec3 coeffs, lowp vec3 coeffs2) {\n"
    "  lowp float dist = dot(coeffs, vec3(pxCoords, 1.0));\n"
    "  lowp float dist2 = dot(coeffs2, vec3(pxCoords, 1.0));\n"
    "  lowp float weight = max(0.0, 1.0 - abs(dist));\n"
    "#if SOFT_AA\n"
    "  lowp float weight2 = max(0.0, 1.0 - 2.0 * abs(dist2));\n"
    "#else\n"
    "  lowp float weight2 = 1.0;\n"
    "#endif\n"
    "  return draw * weight * weight2;\n"
    "}\n"
    "\n"
    "void main() {\n"
    "  lowp vec3 t5 = texture2D(texture, c5).rgb;\n"
    ...
    "\n"
    "  lowp float w05_14 = aaWeight(pxCoords, d05_14, vec3(+2.0, -1.0, +0.0), vec3(+1.0, -1.0, +0.5));\n"
    "  lowp float w02_09 = aaWeight(pxCoords, d02_09, vec3(+2.0, +1.0, -1.0), vec3(+1.0, +1.0, -0.5));\n"
    "  lowp float w01_10 = aaWeight(pxCoords, d01_10, vec3(+2.0, -1.0, -1.0), vec3(+1.0, -1.0, -0.5));\n"
    "  lowp float w06_13 = aaWeight(pxCoords, d06_13, vec3(+2.0, +1.0, -2.0), vec3(+1.0, +1.0, -1.5));\n"
    "\n"
    "  lowp float w05_11 = aaWeight(pxCoords, d05_11, vec3(-1.0, +2.0, +0.0), vec3(+1.0, -1.0, -0.5));\n"
    "  lowp float w07_09 = aaWeight(pxCoords, d07_09, vec3(+1.0, +2.0, -2.0), vec3(+1.0, +1.0, -1.5));\n"
    "  lowp float w04_10 = aaWeight(pxCoords, d04_10, vec3(-1.0, +2.0, -1.0), vec3(+1.0, -1.0, +0.5));\n"
    "  lowp float w06_08 = aaWeight(pxCoords, d06_08, vec3(+1.0, +2.0, -1.0), vec3(+1.0, +1.0, -0.5));\n"
    "\n"
