...
const std::string ShaderManager::cut3UpscalePass1Fragment =
    ...
    "    }\n"
    "  } else {\n"
    "    // TODO FILIPPO... This still doesn't work for every triangle...\n"
    ...
    "  if (triangulate) {\n"
    "    final = triangleInterpolate(t5, t6, t9, t10, flags, pxCoords, 0.25);\n"
    "  } else {\n"
    "    final = quadInterpolate(t5, t6, t9, t10, flags, pxCoords, 0.25);\n"
    "  }\n"
    "\n"
    "  gl_FragColor = vec4(final, 1.0);\n"
    "}";
