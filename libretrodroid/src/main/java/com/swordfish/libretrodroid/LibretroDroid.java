...
public class LibretroDroid {
    ...
    public static final String SHADER_UPSCALE_CUT3_PARAM_BLEND_USE_FAST_LUMA = "BLEND_USE_FAST_LUMA";
    ...
    public static final String SHADER_UPSCALE_CUT3_PARAM_EDGE_MIN_CONTRAST = "EDGE_MIN_CONTRAST";
    public static final String SHADER_UPSCALE_CUT3_PARAM_LUMA_ADJUST_GAMMA = "LUMA_ADJUST_GAMMA";
    public static final String SHADER_UPSCALE_CUT3_PARAM_SPLIT_DEMO_VIEW = "SPLIT_DEMO_VIEW";
