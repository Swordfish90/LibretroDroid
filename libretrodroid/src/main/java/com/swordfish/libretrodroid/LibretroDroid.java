...
public class LibretroDroid {
    ...
    public static final String SHADER_UPSCALE_CUT2_PARAM_EDGE_SHARPENING = "EDGE_SHARPENING";
    public static final String SHADER_UPSCALE_CUT2_PARAM_EDGE_SHARPENING_AMOUNT = "EDGE_SHARPENING_AMOUNT";
    public static final String SHADER_UPSCALE_CUT2_PARAM_EDGE_SHARPENING_MIN_CONTRAST_EDGE = "EDGE_SHARPENING_MIN_CONTRAST_EDGE";
    public static final String SHADER_UPSCALE_CUT2_PARAM_EDGE_SHARPENING_MAX_CONTRAST_EDGE = "EDGE_SHARPENING_MAX_CONTRAST_EDGE";
    public static final String SHADER_UPSCALE_CUT2_PARAM_EDGE_SHARPENING_THRESHOLD = "EDGE_SHARPENING_THRESHOLD";
