...
public class LibretroDroid {
    ...
    public static final String SHADER_UPSCALE_CUT2_PARAM_TEST = "TEST";
    public static final String SHADER_UPSCALE_CUT2_PARAM_REDUCE_ANTIALIASING_AMOUNT = "REDUCE_ANTIALIASING_AMOUNT";
