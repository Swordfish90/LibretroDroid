...
class LibretroDroid {
    ...
    public static native void create(int GLESVersion, String coreFilePath, String gameFilePath, String systemDir, String savesDir, int shaderType, float refreshRate);
