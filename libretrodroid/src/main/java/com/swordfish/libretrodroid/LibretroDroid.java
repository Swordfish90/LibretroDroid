...
public class LibretroDroid {
    ...
    public static final String SHADER_UPSCALE_CUT2_PARAM_REDUCE_ANTI_ALIASING = "REDUCE_ANTI_ALIASING";
    public static final String SHADER_UPSCALE_CUT2_PARAM_REDUCE_ANTI_ALIASING_AMOUNT = "REDUCE_ANTI_ALIASING_AMOUNT";
    public static final String SHADER_UPSCALE_CUT2_PARAM_REDUCE_ANTI_ALIASING_MIN_CONTRAST_EDGE = "REDUCE_ANTI_ALIASING_MIN_CONTRAST_EDGE";
    public static final String SHADER_UPSCALE_CUT2_PARAM_REDUCE_ANTI_ALIASING_CONTRAST_THRESHOLD = "REDUCE_ANTI_ALIASING_CONTRAST_THRESHOLD";
    ...
    public static final String SHADER_UPSCALE_CUT3_PARAM_REDUCE_ANTI_ALIASING = "REDUCE_ANTI_ALIASING";
    public static final String SHADER_UPSCALE_CUT3_PARAM_REDUCE_ANTI_ALIASING_AMOUNT = "REDUCE_ANTI_ALIASING_AMOUNT";
