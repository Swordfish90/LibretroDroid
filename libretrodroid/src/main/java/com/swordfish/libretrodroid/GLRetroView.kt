        ...
        return when (config) {
            ...
            is ShaderConfig.CUT3 -> GLRetroShader(
                ...
                buildParams(
                    ...
                    LibretroDroid.SHADER_UPSCALE_CUT3_PARAM_REDUCE_ANTI_ALIASING to toParam(config.reduceAntiAliasing),
                    LibretroDroid.SHADER_UPSCALE_CUT3_PARAM_REDUCE_ANTI_ALIASING_AMOUNT to toParam(config.reduceAntiAliasingAmount),
